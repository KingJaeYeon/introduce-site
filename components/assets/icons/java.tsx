export function IconJava({className}: { className?: string }) {
    return <svg className={className} fill="currentColor" height="800px" width="800px" version="1.1" id="XMLID_198_"
