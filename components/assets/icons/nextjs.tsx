export function IconNextjs({className}: { className?: string }) {
    return <svg className={className} width="800px" height="800px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
