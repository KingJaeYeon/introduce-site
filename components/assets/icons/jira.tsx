export function IconJira({className}: { className?: string }) {
    return <svg className={className} width="800px" height="800px" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg"
